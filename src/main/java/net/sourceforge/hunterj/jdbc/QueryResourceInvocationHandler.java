...
/**
 * <code>QueryResourceInvocationHandler</code> serves as a base class for <code>InvocationHandler
 * </code> implementations that need to access a {@link JdbcQueryContext}.
 * 
 * @author Jim Hunter
 * @version 1.0
 */
public class QueryResourceInvocationHandler extends GenericInvocationHandler 
	implements QueryContextAccessor
{
	...
	public QueryResourceInvocationHandler(Object invocationTarget, 
										  JdbcQueryContext queryContext) 
	{
